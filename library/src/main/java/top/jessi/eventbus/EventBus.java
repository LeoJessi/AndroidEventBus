...
import top.jessi.eventbus.handler.AsyncEventHandler;
import top.jessi.eventbus.handler.DefaultEventHandler;
import top.jessi.eventbus.handler.EventHandler;
import top.jessi.eventbus.handler.UIThreadEventHandler;
import top.jessi.eventbus.matchpolicy.DefaultMatchPolicy;
import top.jessi.eventbus.matchpolicy.MatchPolicy;
...
public final class EventBus {
     ...
     */
    private final Map<EventType, CopyOnWriteArrayList<Subscription>> mSubcriberMap = new ConcurrentHashMap<EventType,
    ...
    public synchronized boolean isRegistered(Object subscriber) {
        ...
        return mMethodHunter.contains(subscriber);
    }
    ...
    private class EventDispatcher {
        ...
        private EventHandler getEventHandler(ThreadMode mode) {
            if (mode == ThreadMode.ASYNC) return mAsyncEventHandler;
            if (mode == ThreadMode.POST) return mPostThreadHandler;
